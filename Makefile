...
# docker run -it --rm --name my-maven-project -e FHIR_SERVER='http://fhir:3000/4_0_0' -v "$(pwd)":/usr/src/mymaven -v maven-repo:/root/.m2 -w /usr/src/mymaven maven:3.8.4-jdk-11 mvn test
